        ...
        <header class="card__header">
            ...
            <div class="header__group">
                ...
                <div class="header__application">
                    ...
                    <?php else: ?>
                        <a href="<?= htmlspecialchars($application->getCV(), ENT_QUOTES, 'utf-8') ?>">
                            <button class="button button--default-color button--sm rounded-full header__action-button">
                                CV
                            </button>
                        </a>

                        <?php if ($application->getVideo() != null): ?>
                            <a href="<?= htmlspecialchars($application->getVideo(), ENT_QUOTES, 'utf-8') ?>">
